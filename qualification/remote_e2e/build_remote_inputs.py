...
def _approved_record(
    ...
    *,
    ...
    if (
        ...
        raise ValueError(f"approval does not authorize {kind.value} for {workflow_id}")
    return record
...
def build(
    *,
    ...
    wiki_approval = _approved_record(
        wiki_approval_path,
    ...
    contracts = {
        ...
        "wiki-approval.json": wiki_approval.model_dump(mode="json"),
        "poisson-metric-approval.json": metric_approval.model_dump(mode="json"),
        "poisson-execution-approval.json": execution_approval.model_dump(mode="json"),
...
def main() -> None:
    ...
    parser.add_argument("--wiki-approval", type=Path, required=True)
    ...
    build(
        ...
        wiki_approval_path=args.wiki_approval,
