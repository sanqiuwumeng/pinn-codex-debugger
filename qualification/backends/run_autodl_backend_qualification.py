...
RUN_ID = "autodl-backend-qualification-v1"
...
def main() -> None:
    ...
    parser.add_argument("--remote-home", type=PurePosixPath, required=True)
    ...
    remote_environment = (
        ("HOME", str(arguments.remote_home)),
        (
            "PATH",
            f"{arguments.remote_python.parent}:/usr/local/sbin:/usr/local/bin:"
